...
public class BNLJOperator extends JoinOperator {
  ...
  private class BNLJIterator extends JoinIterator {
    ...
    public BNLJIterator() throws QueryPlanException, DatabaseException {
      ...
      rightRecordIterator = BNLJOperator.this.getTransaction().getBlockIterator(this.getRightTableName(), rightIterator, 1);
      leftRecordIterator = BNLJOperator.this.getTransaction().getBlockIterator(this.getLeftTableName(), leftIterator, numBuffers - 2);
    ...
    public void fetchNextRecord() throws DatabaseException {
